...
<html>
    ...
    <body onload="getLocation()">
        ...
        <div class="startHere">
            <h2 style="text-decoration: underline;">Student's Attendance</h1>
            ...
            <form name="myForm" action="" method="POST" enctype="multipart/form-data">
                <table>
                    ...
                    <th><h3 style="padding-top: 30px;">Student Attendance Submission</h3></th>
                    <tr>
                        <td>ID:</td>
                        <td><input type="text" name="studID" size="25" required></td>
                    </tr>
                    <tr>
                        <td>Password:&emsp;&emsp;</td>
                        <td><input type="password" name="studPassword" id="pwd" size="25" required></td>
                    </tr>
                    <tr>
                        <td></td>                            
