...
<table border="" width="80%" cellpadding= "5" align="center">
            ...
            <tr>
                <th>Email</th>
                <td><?=$row['coordinatorEmail']?></td>
            </tr>

             <tr>
                <th>Telephone Number</th>
                <td><?=$row['coordinatorTelNo']?></td>
            </tr>
    ...
    <br>
    <br>
            <center><button><a href="../module1/homepage.php">Back</a></button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<button><a href="../module6/coordinatorUpdateProfile.php">Update</a></button></center>
