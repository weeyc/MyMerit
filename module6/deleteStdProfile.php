...
<div class="startHere">
            ...
            $link = mysqli_connect("localhost", "root", "") or die(mysqli_connect_error());
                ...
                if(isset($_POST['search'])){
                    ...
                    $searchStd = $_POST['searchStd'];
                    $query1 = "SELECT * FROM student WHERE studentID  LIKE'%$searchStd%'ORDER BY student.studentID";
                    $result1 = mysqli_query($link, $query1); 
                }

                    else {

                    $query1 = "SELECT * FROM `student` WHERE studentID= NULL";
                        $result1 = mysqli_query($link, $query1);
                }
                ...
                if(isset($_POST['delete'])){
                    $ID = $_POST['studentID'];
                    echo "$ID";
                    $query2 = "DELETE FROM student WHERE studentID ='$ID'";
...
// total of student count
          ...
          while($row=mysqli_fetch_assoc($result)){
            ...
            ?></p>
            <input type="text" name="searchStd" placeholder="Student ID"><br><br>
            ...
            <table width=100% class = "w3-table-all w3-hoverable">
                ...
                <tr>
                    ...
                    <td><?php echo $student['studentTelNo'];?></td>
                    <?php 
                        $i++;
                    ?>
