<?php
  ...
  $sql = "SELECT  merit.studentID, student.studentName, student.studentTelNo, SUM(totalMerit) AS totalMerit
      FROM merit, student
      WHERE merit.semester ='sem 1 18/19' AND merit.studentID = student.studentID 
...
<html>
  <head>
    ...
    <div class="startHere">
<br>
<center><h1>Student Total Merit Report In Semester 1 18/19</h1></center>
<br>
...
<?php
  ...
  //innner join table of student and merit and count for student who is eligible for hostel
        ...
        FROM merit, student
        WHERE merit.semester ='sem 1 18/19' AND merit.studentID = student.studentID AND totalMerit >100
        GROUP BY merit.studentID) AS num";
