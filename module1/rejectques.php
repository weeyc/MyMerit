...
<html>
    <head>
        ...
        <title>Reject Confirmation</title>
        <script src="https://use.fontawesome.com/3cc6771f24.js"></script>
    </head>
    ...
    <body>
        ...
        <div class="box">
            ...
            <div class="user">
                <i style="color: black;"></i><b>&nbsp; Reject Confirmation</b>
            </div>
            <hr class="hrthick">

            <form name="myForm" action="php_action/reject.php" method="POST" enctype="multipart/form-data">
            <table>
            	<tr>
            		<td>Do You Want Reject This Program?</td>
