...
$query = "SELECT sem, count(*) as number FROM program GROUP BY sem";  
...
<title>Report Semester of Bar Chart</title>
    ...
    <script type="text/javascript">
      ...
      function drawStuff() {
        ...
        var options = {
          ...
          chart: {
            title: 'Report of Semester of Year Bar Chart(2019-2021)',
            subtitle: '' },
          axes: {
            x: {
              0: { side: 'top', label: 'Semester of Year'} // Top x-axis.
            }
          },
          bar: { groupWidth: "50%" }
        };
